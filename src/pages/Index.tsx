    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-12 space-y-16">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Link to="/dsa-mastery">
            <Card className="group card-3d hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30 cursor-pointer h-full white-glow">
              <CardHeader className="pb-4">
                <div className="flex items-center gap-3">
                  <div className="p-3 bg-gradient-to-r from-primary to-secondary rounded-xl group-hover:scale-110 transition-transform white-glow">
                    <BookOpen className="h-6 w-6 text-white" />
                  </div>
                  <div>
                    <CardTitle className="text-lg group-hover:text-primary transition-colors white-text-shadow">DSA Mastery</CardTitle>
              ...
              <CardContent>
                ...
                <Button className="w-full button-3d bg-gradient-to-r from-primary to-secondary white-glow" variant="outline">
                  Start DSA Journey
                </Button>
              </CardContent>
            </Card>
          ...
          <Link to="/cp-contributors">
            <Card className="group card-3d hover:shadow-xl transition-all duration-300 border-2 hover:border-secondary/30 cursor-pointer h-full white-glow">
              <CardHeader className="pb-4">
                <div className="flex items-center gap-3">
                  <div className="p-3 bg-gradient-to-r from-secondary to-accent rounded-xl group-hover:scale-110 transition-transform white-glow">
                    <Code className="h-6 w-6 text-white" />
                  </div>
                  <div>
                    <CardTitle className="text-lg group-hover:text-secondary transition-colors white-text-shadow">Competitive Programming</CardTitle>
              ...
              <CardContent>
                ...
                <Button className="w-full button-3d bg-gradient-to-r from-secondary to-accent white-glow" variant="outline">
          ...
          <Link to="/hackathon-guide">
            <Card className="group card-3d hover:shadow-xl transition-all duration-300 border-2 hover:border-accent/30 cursor-pointer h-full white-glow">
              <CardHeader className="pb-4">
                <div className="flex items-center gap-3">
                  <div className="p-3 bg-gradient-to-r from-accent to-primary rounded-xl group-hover:scale-110 transition-transform white-glow">
                    <Trophy className="h-6 w-6 text-white" />
                  </div>
                  <div>
                    <CardTitle className="text-lg group-hover:text-accent transition-colors white-text-shadow">Hackathon Guide</CardTitle>
              ...
              <CardContent>
                ...
                <Button className="w-full button-3d bg-gradient-to-r from-accent to-primary white-glow" variant="outline">
                  Explore Hackathons
                </Button>
              </CardContent>
            </Card>
          ...
          <Card className="group card-3d hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30 cursor-pointer h-full white-glow">
            <CardHeader className="pb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-lg group-hover:text-primary transition-colors white-text-shadow">FANG Toolkit</CardTitle>
            ...
            <Card className="group card-3d hover:shadow-xl transition-all duration-300 border-2 hover:border-secondary/30 cursor-pointer h-full white-glow">
              <CardHeader className="pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-lg group-hover:text-secondary transition-colors white-text-shadow">Diamond Resume</CardTitle>
          ...
          <Card className="group card-3d hover:shadow-xl transition-all duration-300 border-2 hover:border-accent/30 cursor-pointer h-full white-glow">
            <CardHeader className="pb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-lg group-hover:text-accent transition-colors white-text-shadow">AI Guide</CardTitle>
            ...
            <CardContent>
              ...
              <Button 
                className="w-full button-3d bg-gradient-to-r from-accent to-primary white-glow" 
                variant="outline"
                onClick={() => {
        ...
        <section className="mb-16">
          <Card className="card-3d glass-morphism border-2 border-primary/20 white-glow">
            <CardHeader>
              <div className="flex items-center gap-3">
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                <div className="legend-card p-4 text-center white-glow">
                  <img src="https://i.postimg.cc/zBGJrPTM/icons8-geeksforgeek-48-1.png" alt="GeeksforGeeks" className="h-12 w-12 mx-auto mb-2" />
                  <div className="text-sm font-medium white-text-shadow">GeeksforGeeks</div>
                </div>
                <div className="legend-card p-4 text-center white-glow">
                  <img src="https://i.postimg.cc/rsYbrf0D/icons8-leetcode-24-1.png" alt="LeetCode" className="h-12 w-12 mx-auto mb-2" />
                  <div className="text-sm font-medium white-text-shadow">LeetCode</div>
                </div>
                <div className="legend-card p-4 text-center white-glow">
                  <img src="https://i.postimg.cc/C1ZY6nGn/icons8-codeforces-24-1.png" alt="Codeforces" className="h-12 w-12 mx-auto mb-2" />
                  <div className="text-sm font-medium white-text-shadow">Codeforces</div>
                </div>
                <div className="legend-card p-4 text-center white-glow">
                  <div className="h-12 w-12 mx-auto mb-2 bg-orange-500 rounded flex items-center justify-center text-white font-bold">CC</div>
                  <div className="text-sm font-medium white-text-shadow">CodeChef</div>
                </div>
                <div className="legend-card p-4 text-center white-glow">
                  <img src="https://i.postimg.cc/zDd5zwjh/th-2.jpg" alt="AtCoder" className="h-12 w-12 mx-auto mb-2 rounded" />
                  <div className="text-sm font-medium white-text-shadow">AtCoder</div>
                </div>
                <div className="legend-card p-4 text-center white-glow">
                  <img src="https://i.postimg.cc/1tyzV92Y/coding-ninjas-logo-white.png" alt="Coding Ninjas" className="h-12 w-12 mx-auto mb-2" />
        ...
        <section className="mb-16">
          <Card className="card-3d glass-morphism border-2 border-secondary/20 white-glow">
            <CardHeader>
              <div className="flex items-center gap-3">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={country.country} className="legend-card p-6 bg-gradient-to-br from-primary/10 to-secondary/10 border border-white/20 white-glow">
                    <div className="flex items-center gap-3 mb-4">
                      <img src={country.flag} alt={`${country.country} flag`} className="h-8 w-8 rounded" />
                      <div>
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-accent/10 to-primary/10 rounded-xl border border-white/20 white-glow">
                <h4 className="font-bold text-lg mb-2 white-text-shadow">📝 Reference Summary:</h4>
                ...
                <div className="mt-4">
                  <p className="text-sm font-medium text-primary white-text-shadow">Special Mention: Shreyan Ray (IIT Kharagpur) - Currently holds India Rank #1 among active participants, Codeforces team member confirmed recently.</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <section className="mb-16">
          <Card className="card-3d glass-morphism border-2 border-accent/20 white-glow">
            <CardHeader>
              <div className="flex items-center gap-3">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  <h3 className="font-bold text-2xl text-primary white-text-shadow">🧠 Fascinating Facts</h3>
                  {[
                    ...
                    <div key={fact.title} className="card-3d p-4 bg-primary/5 rounded-xl border border-primary/20 white-glow">
                      <div className="font-medium text-primary white-text-shadow">{fact.title}</div>
                      <div className="text-sm text-muted-foreground mt-2 leading-relaxed">{fact.desc}</div>
                    </div>
                  ))}
                </div>
                ...
                {/* CP Jokes */}
                <div className="space-y-6">
                  <h3 className="font-bold text-2xl text-accent white-text-shadow">🤣 CP Jokes</h3>
                  {[
                    ...
                    <div key={joke.setup} className="card-3d p-4 bg-accent/5 rounded-xl border border-accent/20 white-glow">
                      <div className="font-medium text-accent mb-2 white-text-shadow">{joke.setup}</div>
                      <div className="text-sm text-muted-foreground italic">{joke.punchline}</div>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <section className="text-center">
          <Link to="/resources">
            <Card className="card-3d glass-morphism border-2 border-primary/20 p-12 cursor-pointer hover:border-primary/40 transition-all white-glow">
              <CardContent className="pt-0">
                ...
                <Button size="lg" className="button-3d bg-gradient-to-r from-primary to-secondary hover:from-secondary hover:to-accent text-lg px-8 py-4 white-glow">
